...
export const EditorCanvas = ({ editor }: EditorCanvasProps) => {
  ...
  return (
    <ScrollArea className="flex-1 bg-editor-bg">
...
export const useAcademicEditor = () => {
...
<p>Initial testing shows promising results...</p>`,
    editorProps: {
      attributes: {
        ...
        style: 'font-family: Georgia, Cambria, "Times New Roman", Times, serif; font-size: 16px; line-height: 1.75;',
      },
    },
  });
